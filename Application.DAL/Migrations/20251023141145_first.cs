        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DefaultGraceMinutes = table.Column<int>(type: "int", nullable: false, defaultValue: 0),
                    Address = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PhoneNumber = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Email = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    BillingRatePerEmployee = table.Column<decimal>(type: "decimal(18,2)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CompanyQRCodes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CompanyQRCodes_Companies_CompanyId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CompanyId = table.Column<int>(type: "int", nullable: false),
                    ActiveEmployeeCount = table.Column<int>(type: "int", nullable: false),
                    RatePerEmployee = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StandardStartTime = table.Column<TimeSpan>(type: "time", nullable: true),
                    StandardEndTime = table.Column<TimeSpan>(type: "time", nullable: true),
                    AllowedDailyMinutes = table.Column<int>(type: "int", nullable: false),
                    CompanyId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MinutesDeducted = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CompanyQRCodes_CompanyId",
                table: "CompanyQRCodes",
                column: "CompanyId",
                unique: true,
                filter: "[IsActive] = 1");

            migrationBuilder.CreateIndex(
                name: "IX_CompanyQRCodes_CompanyId_IsActive",
                table: "CompanyQRCodes",
                columns: new[] { "CompanyId", "IsActive" });

            migrationBuilder.CreateIndex(
                name: "IX_CompanyQRCodes_IsActive",
                table: "CompanyQRCodes",
                column: "IsActive");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PayrollDeductions_CreatedAt",
